...
class LiepinSpiderSpider(scrapy.Spider):
    ...
    # pos_class_arr = [
    #     {"后端开发": ["Java", "C++", "C", "Python", "Go", "Php", "Hadoop", "Spark", "HBase", "全栈工程师"]},
    #     {"前端开发": ["U3D", "Web前端", "Javascript"]},
    #     {"移动端开发": ["iOS", "Android"]},
    #     {"人工智能": ["数据挖掘", "自然语言处理", "搜索引擎"]},
    #     {"测试运维": ["测试工程师", "测试开发", "网络工程师"]},
    #     {"数据库": ["DBA"]}
    # ]

    # pos_class_arr = [
    #     {"C++": "后端开发"}, {"Java": "后端开发"}, {"C": "后端开发"}, {"Python": "后端开发"}, {"Go": "后端开发"}, {"Php": "后端开发"},
    #     {"Hadoop": "后端开发"}, {"Spark": "后端开发"}, {"HBase": "后端开发"}, {"全栈工程师": "后端开发"}, {"U3D": "前端开发"}, {"Web前端": "前端开发"},
